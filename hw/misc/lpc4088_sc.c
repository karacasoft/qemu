...
static void lpc4088_sc_write(void *opaque, hwaddr offset, uint64_t val64, unsigned int size) {
    LPC4088SCState *s = opaque;
    uint32_t value = (uint32_t) val64;
			 
	DEBUG_PRINT("(%s, value = 0x%" PRIx32 ")\n",lpc4088_sc_register_name(offset), (uint32_t) value);
...
static void lpc4088_sc_remote_ctrl_callback(RemoteCtrlState *rcs, RemoteCtrlMessage *msg) {
    LPC4088SCState *s = LPC4088SC(rcs->connected_device);
