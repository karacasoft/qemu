...
typedef struct q_obj_VirtioMEMDeviceInfo_wrapper q_obj_VirtioMEMDeviceInfo_wrapper;
...
struct q_obj_VirtioMEMDeviceInfo_wrapper {
...
struct MemoryDeviceInfo {
    ...
    union { /* union tag is @type */
        ...
        q_obj_VirtioMEMDeviceInfo_wrapper virtio_mem;
    } u;
};
