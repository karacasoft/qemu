...
void visit_type_PciDeviceInfo_members(Visitor *v, PciDeviceInfo *obj, Error **errp)
{
    ...
    visit_type_int(v, "irq_pin", &obj->irq_pin, &err);
    if (err) {
        goto out;
    }
...
void visit_type_VirtioMEMDeviceInfo_members(Visitor *v, VirtioMEMDeviceInfo *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_size(v, "requested-size", &obj->requested_size, &err);
    if (err) {
        goto out;
    }
    visit_type_size(v, "size", &obj->size, &err);
    ...
    visit_type_size(v, "max-size", &obj->max_size, &err);
    if (err) {
        goto out;
    }
...
void visit_type_VirtioMEMDeviceInfo(Visitor *v, const char *name, VirtioMEMDeviceInfo **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(VirtioMEMDeviceInfo), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_VirtioMEMDeviceInfo_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_VirtioMEMDeviceInfo_wrapper_members(Visitor *v, q_obj_VirtioMEMDeviceInfo_wrapper *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_VirtioMEMDeviceInfo(v, "data", &obj->data, &err);
    if (err) {
        goto out;
    }
...
void visit_type_MemoryDeviceInfo_members(Visitor *v, MemoryDeviceInfo *obj, Error **errp)
{
    ...
    case MEMORY_DEVICE_INFO_KIND_VIRTIO_MEM:
        visit_type_q_obj_VirtioMEMDeviceInfo_wrapper_members(v, &obj->u.virtio_mem, &err);
        break;
    default:
        abort();
    }
...
void visit_type_q_obj_MEMORY_DEVICE_SIZE_CHANGE_arg_members(Visitor *v, q_obj_MEMORY_DEVICE_SIZE_CHANGE_arg *obj, Error **errp)
{
    Error *err = NULL;
