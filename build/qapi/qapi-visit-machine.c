...
void visit_type_NumaOptions_members(Visitor *v, NumaOptions *obj, Error **errp)
{
    ...
    case NUMA_OPTIONS_TYPE_HMAT_LB:
        visit_type_NumaHmatLBOptions_members(v, &obj->u.hmat_lb, &err);
        break;
    case NUMA_OPTIONS_TYPE_HMAT_CACHE:
        visit_type_NumaHmatCacheOptions_members(v, &obj->u.hmat_cache, &err);
        break;
    default:
        abort();
    }
...
void visit_type_NumaNodeOptions_members(Visitor *v, NumaNodeOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "initiator", &obj->has_initiator)) {
        visit_type_uint16(v, "initiator", &obj->initiator, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_HmatLBMemoryHierarchy(Visitor *v, const char *name, HmatLBMemoryHierarchy *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &HmatLBMemoryHierarchy_lookup, errp);
    *obj = value;
}

void visit_type_HmatLBDataType(Visitor *v, const char *name, HmatLBDataType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &HmatLBDataType_lookup, errp);
    *obj = value;
}

void visit_type_NumaHmatLBOptions_members(Visitor *v, NumaHmatLBOptions *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_uint16(v, "target", &obj->target, &err);
    if (err) {
        goto out;
    }
    visit_type_HmatLBMemoryHierarchy(v, "hierarchy", &obj->hierarchy, &err);
    if (err) {
        goto out;
    }
    visit_type_HmatLBDataType(v, "data-type", &obj->data_type, &err);
    if (err) {
        goto out;
    }
    if (visit_optional(v, "latency", &obj->has_latency)) {
        visit_type_uint64(v, "latency", &obj->latency, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "bandwidth", &obj->has_bandwidth)) {
        visit_type_size(v, "bandwidth", &obj->bandwidth, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_NumaHmatLBOptions(Visitor *v, const char *name, NumaHmatLBOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(NumaHmatLBOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_NumaHmatLBOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_HmatCacheAssociativity(Visitor *v, const char *name, HmatCacheAssociativity *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &HmatCacheAssociativity_lookup, errp);
    *obj = value;
}

void visit_type_HmatCacheWritePolicy(Visitor *v, const char *name, HmatCacheWritePolicy *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &HmatCacheWritePolicy_lookup, errp);
    *obj = value;
}

void visit_type_NumaHmatCacheOptions_members(Visitor *v, NumaHmatCacheOptions *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_uint32(v, "node-id", &obj->node_id, &err);
    if (err) {
        goto out;
    }
    ...
    visit_type_uint8(v, "level", &obj->level, &err);
    if (err) {
        goto out;
    }
    visit_type_HmatCacheAssociativity(v, "associativity", &obj->associativity, &err);
    if (err) {
        goto out;
    }
    visit_type_HmatCacheWritePolicy(v, "policy", &obj->policy, &err);
    if (err) {
        goto out;
    }
    visit_type_uint16(v, "line", &obj->line, &err);
    if (err) {
        goto out;
    }
...
void visit_type_NumaHmatCacheOptions(Visitor *v, const char *name, NumaHmatCacheOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(NumaHmatCacheOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_NumaHmatCacheOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
