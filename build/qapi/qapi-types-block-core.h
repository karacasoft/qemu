...
typedef struct BlockExportNbd BlockExportNbd;
...
typedef struct q_obj_BlockExport_base q_obj_BlockExport_base;
...
void qapi_free_BlockExportNbd(BlockExportNbd *obj);
...
void qapi_free_BlockExport(BlockExport *obj);
