...
void visit_type_NetdevVhostVDPAOptions_members(Visitor *v, NetdevVhostVDPAOptions *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "vhostdev", &obj->has_vhostdev)) {
        visit_type_str(v, "vhostdev", &obj->vhostdev, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_NetdevVhostVDPAOptions(Visitor *v, const char *name, NetdevVhostVDPAOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(NetdevVhostVDPAOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_NetdevVhostVDPAOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_Netdev_members(Visitor *v, Netdev *obj, Error **errp)
{
    ...
    case NET_CLIENT_DRIVER_VHOST_VDPA:
        visit_type_NetdevVhostVDPAOptions_members(v, &obj->u.vhost_vdpa, &err);
        break;
