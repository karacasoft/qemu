...
void visit_type_GrabToggleKeys(Visitor *v, const char *name, GrabToggleKeys *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &GrabToggleKeys_lookup, errp);
    *obj = value;
}
...
void visit_type_DisplayGTK_members(Visitor *v, DisplayGTK *obj, Error **errp)
{
    ...
    if (visit_optional(v, "zoom-to-fit", &obj->has_zoom_to_fit)) {
        visit_type_bool(v, "zoom-to-fit", &obj->zoom_to_fit, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_DisplayEGLHeadless_members(Visitor *v, DisplayEGLHeadless *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "rendernode", &obj->has_rendernode)) {
        visit_type_str(v, "rendernode", &obj->rendernode, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_DisplayEGLHeadless(Visitor *v, const char *name, DisplayEGLHeadless **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(DisplayEGLHeadless), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_DisplayEGLHeadless_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_DisplayGLMode(Visitor *v, const char *name, DisplayGLMode *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &DisplayGLMode_lookup, errp);
    *obj = value;
}

void visit_type_DisplayCurses_members(Visitor *v, DisplayCurses *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "charset", &obj->has_charset)) {
        visit_type_str(v, "charset", &obj->charset, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_DisplayCurses(Visitor *v, const char *name, DisplayCurses **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(DisplayCurses), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_DisplayCurses_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_DisplayOptions_base_members(Visitor *v, q_obj_DisplayOptions_base *obj, Error **errp)
{
    ...
    if (visit_optional(v, "show-cursor", &obj->has_show_cursor)) {
        visit_type_bool(v, "show-cursor", &obj->show_cursor, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "gl", &obj->has_gl)) {
        visit_type_DisplayGLMode(v, "gl", &obj->gl, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_DisplayOptions_members(Visitor *v, DisplayOptions *obj, Error **errp)
{
    ...
    case DISPLAY_TYPE_CURSES:
        visit_type_DisplayCurses_members(v, &obj->u.curses, &err);
        break;
    case DISPLAY_TYPE_EGL_HEADLESS:
        visit_type_DisplayEGLHeadless_members(v, &obj->u.egl_headless, &err);
        break;
