...
void visit_type_PCIELinkSpeed(Visitor *v, const char *name, PCIELinkSpeed *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &PCIELinkSpeed_lookup, errp);
    *obj = value;
}

void visit_type_PCIELinkWidth(Visitor *v, const char *name, PCIELinkWidth *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &PCIELinkWidth_lookup, errp);
    *obj = value;
}
