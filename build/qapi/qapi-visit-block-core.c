...
void visit_type_ImageInfoSpecificQCow2_members(Visitor *v, ImageInfoSpecificQCow2 *obj, Error **errp)
{
    ...
    visit_type_Qcow2CompressionType(v, "compression-type", &obj->compression_type, &err);
    if (err) {
        goto out;
    }
...
void visit_type_BlockMeasureInfo_members(Visitor *v, BlockMeasureInfo *obj, Error **errp)
{
    ...
    if (visit_optional(v, "bitmaps", &obj->has_bitmaps)) {
        visit_type_int(v, "bitmaps", &obj->bitmaps, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_q_obj_query_named_block_nodes_arg_members(Visitor *v, q_obj_query_named_block_nodes_arg *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "flat", &obj->has_flat)) {
        visit_type_bool(v, "flat", &obj->flat, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptionsRbd_members(Visitor *v, BlockdevOptionsRbd *obj, Error **errp)
{
    ...
    if (visit_optional(v, "namespace", &obj->has_q_namespace)) {
        visit_type_str(v, "namespace", &obj->q_namespace, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevOptions_members(Visitor *v, BlockdevOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_CLOOP:
        ...
        break;
    case BLOCKDEV_DRIVER_COMPRESS:
        visit_type_BlockdevOptionsGenericFormat_members(v, &obj->u.compress, &err);
        break;
    case BLOCKDEV_DRIVER_COPY_ON_READ:
...
void visit_type_Qcow2CompressionType(Visitor *v, const char *name, Qcow2CompressionType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &Qcow2CompressionType_lookup, errp);
    *obj = value;
}
...
void visit_type_BlockdevAmendOptionsLUKS_members(Visitor *v, BlockdevAmendOptionsLUKS *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_QCryptoBlockAmendOptionsLUKS_members(v, (QCryptoBlockAmendOptionsLUKS *)obj, &err);
    if (err) {
        goto out;
    }
...
void visit_type_BlockdevAmendOptionsLUKS(Visitor *v, const char *name, BlockdevAmendOptionsLUKS **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevAmendOptionsLUKS), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevAmendOptionsLUKS_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockdevAmendOptionsQcow2_members(Visitor *v, BlockdevAmendOptionsQcow2 *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "encrypt", &obj->has_encrypt)) {
        visit_type_QCryptoBlockAmendOptions(v, "encrypt", &obj->encrypt, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_BlockdevAmendOptionsQcow2(Visitor *v, const char *name, BlockdevAmendOptionsQcow2 **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevAmendOptionsQcow2), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevAmendOptionsQcow2_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_BlockdevAmendOptions_base_members(Visitor *v, q_obj_BlockdevAmendOptions_base *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_BlockdevAmendOptions_members(Visitor *v, BlockdevAmendOptions *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_q_obj_BlockdevAmendOptions_base_members(v, (q_obj_BlockdevAmendOptions_base *)obj, &err);
    if (err) {
        goto out;
    }
    switch (obj->driver) {
    case BLOCKDEV_DRIVER_LUKS:
        visit_type_BlockdevAmendOptionsLUKS_members(v, &obj->u.luks, &err);
        break;
    case BLOCKDEV_DRIVER_QCOW2:
        visit_type_BlockdevAmendOptionsQcow2_members(v, &obj->u.qcow2, &err);
        break;
    case BLOCKDEV_DRIVER_BLKDEBUG:
        break;
    case BLOCKDEV_DRIVER_BLKLOGWRITES:
...
void visit_type_BlockdevAmendOptions(Visitor *v, const char *name, BlockdevAmendOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockdevAmendOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockdevAmendOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_q_obj_x_blockdev_amend_arg_members(Visitor *v, q_obj_x_blockdev_amend_arg *obj, Error **errp)
{
    Error *err = NULL;
    ...
    visit_type_BlockdevAmendOptions(v, "options", &obj->options, &err);
    if (err) {
        goto out;
    }
    if (visit_optional(v, "force", &obj->has_force)) {
...
void visit_type_NbdServerOptions_members(Visitor *v, NbdServerOptions *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_NbdServerOptions(Visitor *v, const char *name, NbdServerOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(NbdServerOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_NbdServerOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockExportNbd_members(Visitor *v, BlockExportNbd *obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_BlockExportNbd(Visitor *v, const char *name, BlockExportNbd **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockExportNbd), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockExportNbd_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_BlockExportType(Visitor *v, const char *name, BlockExportType *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &BlockExportType_lookup, errp);
    *obj = value;
}

void visit_type_q_obj_BlockExport_base_members(Visitor *v, q_obj_BlockExport_base *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_BlockExportType(v, "type", &obj->type, &err);
    if (err) {
        goto out;
    }
...
void visit_type_BlockExport_members(Visitor *v, BlockExport *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_q_obj_BlockExport_base_members(v, (q_obj_BlockExport_base *)obj, &err);
    if (err) {
        goto out;
    }
    switch (obj->type) {
    case BLOCK_EXPORT_TYPE_NBD:
        visit_type_BlockExportNbd_members(v, &obj->u.nbd, &err);
        break;
    default:
        abort();
    }
...
void visit_type_BlockExport(Visitor *v, const char *name, BlockExport **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(BlockExport), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_BlockExport_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
