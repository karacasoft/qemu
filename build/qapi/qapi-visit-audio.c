...
void visit_type_AudiodevPerDirectionOptions_members(Visitor *v, AudiodevPerDirectionOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "mixing-engine", &obj->has_mixing_engine)) {
        visit_type_bool(v, "mixing-engine", &obj->mixing_engine, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_AudiodevJackPerDirectionOptions_members(Visitor *v, AudiodevJackPerDirectionOptions *obj, Error **errp)
{
    Error *err = NULL;
    ...
    if (visit_optional(v, "server-name", &obj->has_server_name)) {
        visit_type_str(v, "server-name", &obj->server_name, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "client-name", &obj->has_client_name)) {
        visit_type_str(v, "client-name", &obj->client_name, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "connect-ports", &obj->has_connect_ports)) {
        visit_type_str(v, "connect-ports", &obj->connect_ports, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "start-server", &obj->has_start_server)) {
        visit_type_bool(v, "start-server", &obj->start_server, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "exact-name", &obj->has_exact_name)) {
        visit_type_bool(v, "exact-name", &obj->exact_name, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_AudiodevJackPerDirectionOptions(Visitor *v, const char *name, AudiodevJackPerDirectionOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(AudiodevJackPerDirectionOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_AudiodevJackPerDirectionOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_AudiodevJackOptions_members(Visitor *v, AudiodevJackOptions *obj, Error **errp)
{
    Error *err = NULL;

    if (visit_optional(v, "in", &obj->has_in)) {
        visit_type_AudiodevJackPerDirectionOptions(v, "in", &obj->in, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "out", &obj->has_out)) {
        visit_type_AudiodevJackPerDirectionOptions(v, "out", &obj->out, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_AudiodevJackOptions(Visitor *v, const char *name, AudiodevJackOptions **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(AudiodevJackOptions), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_AudiodevJackOptions_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_AudiodevPaPerDirectionOptions_members(Visitor *v, AudiodevPaPerDirectionOptions *obj, Error **errp)
{
    ...
    if (visit_optional(v, "stream-name", &obj->has_stream_name)) {
        visit_type_str(v, "stream-name", &obj->stream_name, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_Audiodev_members(Visitor *v, Audiodev *obj, Error **errp)
{
    ...
    case AUDIODEV_DRIVER_JACK:
        visit_type_AudiodevJackOptions_members(v, &obj->u.jack, &err);
        break;
