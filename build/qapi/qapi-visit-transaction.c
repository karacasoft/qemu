...
void visit_type_q_obj_BlockDirtyBitmapMerge_wrapper_members(Visitor *v, q_obj_BlockDirtyBitmapMerge_wrapper *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_BlockDirtyBitmapMerge(v, "data", &obj->data, &err);
    if (err) {
        goto out;
    }
...
void visit_type_TransactionAction_members(Visitor *v, TransactionAction *obj, Error **errp)
{
    ...
    case TRANSACTION_ACTION_KIND_BLOCK_DIRTY_BITMAP_REMOVE:
        visit_type_q_obj_BlockDirtyBitmap_wrapper_members(v, &obj->u.block_dirty_bitmap_remove, &err);
        break;
    ...
    case TRANSACTION_ACTION_KIND_BLOCK_DIRTY_BITMAP_ENABLE:
        visit_type_q_obj_BlockDirtyBitmap_wrapper_members(v, &obj->u.block_dirty_bitmap_enable, &err);
        break;
    case TRANSACTION_ACTION_KIND_BLOCK_DIRTY_BITMAP_DISABLE:
        visit_type_q_obj_BlockDirtyBitmap_wrapper_members(v, &obj->u.block_dirty_bitmap_disable, &err);
        break;
    case TRANSACTION_ACTION_KIND_BLOCK_DIRTY_BITMAP_MERGE:
        visit_type_q_obj_BlockDirtyBitmapMerge_wrapper_members(v, &obj->u.block_dirty_bitmap_merge, &err);
        break;
