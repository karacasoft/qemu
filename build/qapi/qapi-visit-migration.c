...
void visit_type_XBZRLECacheStats_members(Visitor *v, XBZRLECacheStats *obj, Error **errp)
{
    ...
    visit_type_number(v, "encoding-rate", &obj->encoding_rate, &err);
    if (err) {
        goto out;
    }
...
void visit_type_MultiFDCompression(Visitor *v, const char *name, MultiFDCompression *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &MultiFDCompression_lookup, errp);
    *obj = value;
}
...
void visit_type_MigrateSetParameters_members(Visitor *v, MigrateSetParameters *obj, Error **errp)
{
    ...
    if (visit_optional(v, "throttle-trigger-threshold", &obj->has_throttle_trigger_threshold)) {
        visit_type_int(v, "throttle-trigger-threshold", &obj->throttle_trigger_threshold, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "cpu-throttle-tailslow", &obj->has_cpu_throttle_tailslow)) {
        visit_type_bool(v, "cpu-throttle-tailslow", &obj->cpu_throttle_tailslow, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "multifd-compression", &obj->has_multifd_compression)) {
        visit_type_MultiFDCompression(v, "multifd-compression", &obj->multifd_compression, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "multifd-zlib-level", &obj->has_multifd_zlib_level)) {
        visit_type_int(v, "multifd-zlib-level", &obj->multifd_zlib_level, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "multifd-zstd-level", &obj->has_multifd_zstd_level)) {
        visit_type_int(v, "multifd-zstd-level", &obj->multifd_zstd_level, &err);
        if (err) {
            goto out;
        }
    }
...
void visit_type_MigrationParameters_members(Visitor *v, MigrationParameters *obj, Error **errp)
{
    ...
    if (visit_optional(v, "throttle-trigger-threshold", &obj->has_throttle_trigger_threshold)) {
        visit_type_uint8(v, "throttle-trigger-threshold", &obj->throttle_trigger_threshold, &err);
        if (err) {
            goto out;
        }
    }
    ...
    if (visit_optional(v, "multifd-zlib-level", &obj->has_multifd_zlib_level)) {
        visit_type_uint8(v, "multifd-zlib-level", &obj->multifd_zlib_level, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "multifd-zstd-level", &obj->has_multifd_zstd_level)) {
        visit_type_uint8(v, "multifd-zstd-level", &obj->multifd_zstd_level, &err);
        if (err) {
            goto out;
        }
    }
