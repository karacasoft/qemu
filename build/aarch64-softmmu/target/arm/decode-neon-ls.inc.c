...
static bool disas_neon_ls(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0xf4000000:
        /* 11110100 0..0.... ........ ........ */
        /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/neon-ls.decode:35 */
    ...
    case 0xf4800000:
        ...
        case 0x0:
            /* 11110100 1..0.... ....00.. ........ */
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/neon-ls.decode:47 */
        ...
        case 0x1:
            /* 11110100 1..0.... ....01.. ........ */
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/neon-ls.decode:49 */
            disas_neon_ls_extract_disas_neon_ls_Fmt_3(ctx, &u.f_disas_neon_ls2, insn);
            if (trans_VLDST_single(ctx, &u.f_disas_neon_ls2)) return true;
            return false;
        case 0x2:
            /* 11110100 1..0.... ....10.. ........ */
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/neon-ls.decode:51 */
        ...
        case 0x3:
            ...
            case 0x1:
                /* 11110100 1.10.... ....11.. ........ */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/neon-ls.decode:40 */
