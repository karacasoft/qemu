...
static bool disas_vfp_uncond(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0xfe000a00:
        /* 11111110 0....... ....1010 .0.0.... */
        /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:47 */
    ...
    case 0xfe000b00:
        /* 11111110 0....... ....1011 .0.0.... */
        /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:49 */
    ...
    case 0xfe800a00:
        ...
        case 0x0:
            ...
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:52 */
    ...
    case 0xfe800a40:
        ...
        case 0x0:
            ...
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:53 */
            disas_vfp_uncond_extract_vfp_dnm_s(ctx, &u.f_disas_vfp_uncond0, insn);
        ...
        case 0x3:
            ...
            case 0x2:
                ...
                case 0x0:
                    ...
                    /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:58 */
            ...
            case 0x3:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:64 */
    ...
    case 0xfe800b00:
        ...
        case 0x0:
            ...
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:55 */
    ...
    case 0xfe800b40:
        ...
        case 0x0:
            ...
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:56 */
            disas_vfp_uncond_extract_vfp_dnm_d(ctx, &u.f_disas_vfp_uncond0, insn);
        ...
        case 0x3:
            ...
            case 0x2:
                ...
                case 0x0:
                    ...
                    /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:60 */
                    if (trans_VRINT(ctx, &u.f_disas_vfp_uncond2)) return true;
                    return false;
                }
                return false;
            case 0x3:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/vfp-uncond.decode:66 */
