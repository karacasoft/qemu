...
static bool disas_a32_uncond(DisasContext *ctx, uint32_t insn)
{
    ...
    case 0x78:
        ...
        case 0x01000000:
            ...
            case 0x0:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:43 */
        ...
        case 0x01010000:
            ...
            case 0x00000000:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:56 */
    ...
    case 0x7a:
        ...
        case 0x00100000:
            /* 11110100 .001.... ........ ........ */
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:73 */
        ...
        case 0x00500000:
            ...
            case 0xf:
                /* 11110100 .101.... 1111.... ........ */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:62 */
        ...
        case 0x01100000:
            ...
            case 0xf:
                /* 11110101 .001.... 1111.... ........ */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:61 */
                if (trans_PLDW(ctx, &u.f_empty)) return true;
                return false;
            }
            return false;
        case 0x01500000:
            ...
            case 0xf:
                /* 11110101 .101.... 1111.... ........ */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:60 */
        ...
        case 0x01700000:
            ...
            case 0x000ff010:
                ...
                case 0x0000000f:
                    ...
                    /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:49 */
            ...
            case 0x000ff040:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:50 */
                if (trans_DSB(ctx, &u.f_empty)) return true;
                return false;
            case 0x000ff050:
                /* 11110101 01111111 11110000 0101.... */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:51 */
                if (trans_DMB(ctx, &u.f_empty)) return true;
                return false;
            case 0x000ff060:
                /* 11110101 01111111 11110000 0110.... */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:52 */
            ...
            case 0x000ff070:
                ...
                case 0x00000000:
                    ...
                    /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:53 */
    ...
    case 0x7b:
        ...
        case 0x00100000:
            /* 11110110 .001.... ........ ...0.... */
            /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:74 */
            if (trans_PLDW(ctx, &u.f_empty)) return true;
            return false;
        case 0x00500000:
            /* 11110110 .101.... ........ ...0.... */
            ...
            case 0xf:
                /* 11110110 .101.... 1111.... ...0.... */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:66 */
                if (trans_PLI(ctx, &u.f_empty)) return true;
                return false;
            }
            return false;
        case 0x01100000:
            ...
            case 0xf:
                /* 11110111 .001.... 1111.... ...0.... */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:65 */
                if (trans_PLDW(ctx, &u.f_empty)) return true;
                return false;
            }
            return false;
        case 0x01500000:
            ...
            case 0xf:
                /* 11110111 .101.... 1111.... ...0.... */
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:64 */
                if (trans_PLD(ctx, &u.f_empty)) return true;
                return false;
            }
            return false;
    ...
    case 0x7c:
        ...
        case 0x00100a00:
            ...
            case 0x00000000:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:41 */
        ...
        case 0x00400500:
            ...
            case 0xd:
                ...
                /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:42 */
    ...
    case 0x7d:
        /* 1111101. ........ ........ ........ */
        /* /home/ubuntu/CmpE443_Qemu/qemu/target/arm/a32-uncond.decode:33 */
