...
void visit_type_FeatureEnum1(Visitor *v, const char *name, FeatureEnum1 *obj, Error **errp)
{
    int value = *obj;
    visit_type_enum(v, name, &value, &FeatureEnum1_lookup, errp);
    *obj = value;
}

void visit_type_q_obj_FeatureUnion1_base_members(Visitor *v, q_obj_FeatureUnion1_base *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_FeatureEnum1(v, "tag", &obj->tag, &err);
    if (err) {
        goto out;
    }
...
void visit_type_FeatureUnion1_members(Visitor *v, FeatureUnion1 *obj, Error **errp)
{
    Error *err = NULL;

    visit_type_q_obj_FeatureUnion1_base_members(v, (q_obj_FeatureUnion1_base *)obj, &err);
    if (err) {
        goto out;
    }
    switch (obj->tag) {
    case FEATURE_ENUM1_EINS:
        visit_type_FeatureStruct1_members(v, &obj->u.eins, &err);
        break;
...
void visit_type_FeatureUnion1(Visitor *v, const char *name, FeatureUnion1 **obj, Error **errp)
{
    Error *err = NULL;

    visit_start_struct(v, name, (void **)obj, sizeof(FeatureUnion1), &err);
    if (err) {
        goto out;
    }
    if (!*obj) {
    ...
    visit_type_FeatureUnion1_members(v, *obj, &err);
    if (err) {
        goto out_obj;
    }
    visit_check_struct(v, &err);
...
void visit_type_FeatureAlternate1(Visitor *v, const char *name, FeatureAlternate1 **obj, Error **errp)
{
    Error *err = NULL;
...
void visit_type_q_obj_test_features0_arg_members(Visitor *v, q_obj_test_features0_arg *obj, Error **errp)
{
    Error *err = NULL;
